...
const Hero = () => {
  ...
  return (
    <div className="bg-[url('/images/hero_1.png')] bg-cover bg-no-repeat relative h-screen grid place-content-center">
      <div className="bg-[#00000033]  absolute top-0 right-0 bottom-0 left-0" />
      <div className="w-[80%] h-fit mx-auto grid gap-[2rem] place-content-center z-20 relative">
